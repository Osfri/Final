...
class AlarmDto(val name:String?,val starttime:String?,val endtime:String?,val code:String?) : Parcelable {
    ...
    override fun toString(): String {
        return "AlarmDto(name=$name, starttime=$starttime, endtime=$endtime, code=$code)"
    }
